...
class OperateCamera:
    ...
    def __init__(self, clipping_distance=2):
        ...
        self.clipping_distance_in_meters = clipping_distance  # 2 meter
    ...
    def catch_frame(self):
        ...
        # new algo
        full_depth = np.zeros((720, 1280))
        full_mask = np.zeros((720, 1280))
...
def visualization_of_points(points):
    o3d.visualization.draw_geometries([points], 'Demonstration', 1920, 1080)